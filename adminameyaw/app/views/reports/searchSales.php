    ...
    <div class="invoice-container">
        ...
        <table>
            ...
            <tbody>
                ...
                foreach ($listOrderStatus as $index => $item): 
                ?>
                <tr>
                    <td><?= $num++; ?></td>
                    <?php if ($index === array_search($item->clientName, array_keys($clientCounts))) : ?>
                        <td rowspan="<?= $clientCounts[$item->clientName] ?>"><?= $item->clientName ?></td>
                    <?php endif; ?>
