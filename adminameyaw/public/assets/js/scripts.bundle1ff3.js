...
var KTLayoutChat = function () {
	...
	var _handeMessaging = function(element) {
		...
		setTimeout(function() {
			...
			html += '	</div>';
			html += '	<div>';
			html += '		<a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">IT Team</a>';
			html += '		<span class="text-muted font-size-sm">Just now</span>';
			html += '	</div>';
			html += '</div>';
			html += '<div class="mt-2 rounded p-5 bg-light-success text-dark-50 font-weight-bold font-size-lg text-left max-w-400px">';
			html += 'Dear user, this functionality is currently under development. For any urgent issues, please contact the IT team directly for assistance. Thank you for your understanding.';
			html += '</div>';
