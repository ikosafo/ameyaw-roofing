...
function loadContent(tabId) {
    ...
    switch (tabId) {
        case 'misAdmin':
            url = `${urlroot}/examination/misadmin`;
            break;
        case 'superAdmin':
            url = `${urlroot}/examination/superadmin`;
            break;
        case 'examException':
        ...
        case 'specialRegistration':
            ...
            dataToSend = { regType: 'Examination' };
            break;
        case 'regenerateIndex':
            url = `${urlroot}/registration/regenerateIndex`;
            break;
        case 'generateReport':
            url = `${urlroot}/examination/generateReport`;
            break;
        case 'exportData':
            ...
            break;
        case 'resultStatus':
            url = `${urlroot}/examination/resultStatus`;
            break;
        case 'extractData':
            url = `${urlroot}/examination/extractData`;
            break;
        case 'reporting':
            url = `${urlroot}/examination/reporting`;
            break;
        case 'summaryData':
            url = `${urlroot}/examination/summaryData`;
            break;
        case 'overview':
        default:
            url = `${urlroot}/examination/overview`;
            break;
    }
