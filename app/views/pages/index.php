		...
		<div class="container">
			...
			<div class="row">
				<div class="products-slider 5col owl-carousel owl-theme appear-animate" data-owl-options="{
					...
					<div class="product-default">
						<figure>
							<a href="demo27-product.html">
								<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/products/product-1.jpg" width="280"
					...
					<div class="product-default">
						<figure>
							<a href="demo27-product.html">
								<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/products/product-2.jpg" width="280"
									height="280" alt="product">
							</a>
							<div class="label-group">
								<div class="product-label label-hot">HOT</div>
					...
					<div class="product-default">
						<figure>
							<a href="demo27-product.html">
								<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/products/product-3.jpg" width="280"
									height="280" alt="product">
							</a>
							<div class="label-group">
					...
					<div class="product-default">
						<figure>
							<a href="demo27-product.html">
								<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/products/product-4.jpg" width="280"
									height="280" alt="product">
							</a>
							<div class="label-group">
					...
					<div class="product-default">
						<figure>
							<a href="demo27-product.html">
								<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/products/product-5.jpg" width="280"
									height="280" alt="product">
							</a>
						</figure>
						<div class="product-details">
					...
					<div class="product-default">
						<figure>
							<a href="demo27-product.html">
								<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/products/product-6.jpg" width="280"
									height="280" alt="product">
							</a>
							<div class="label-group">
			...
			<div class="categories-slider owl-carousel owl-theme mb-4 appear-animate" data-owl-options="{
				...
				<div class="product-category">
					<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/icons/icon-1.png" alt="icon" width="60" height="60">
					<div class="category-content">
						<h3 class="font2 ls-0 text-uppercase mb-0">Bike Saddles</h3>
					</div>
				</div>
				<div class="product-category">
					<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/icons/icon-2.png" alt="icon" width="60" height="60">
					<div class="category-content">
						<h3 class="font2 ls-0 text-uppercase mb-0">Bike Pedals</h3>
					</div>
				</div>
				<div class="product-category">
					<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/icons/icon-3.png" alt="icon" width="60" height="60">
					<div class="category-content">
						<h3 class="font2 ls-0 text-uppercase mb-0">Bike Frames</h3>
					</div>
				</div>
				<div class="product-category">
					<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/icons/icon-4.png" alt="icon" width="60" height="60">
					<div class="category-content">
						<h3 class="font2 ls-0 text-uppercase mb-0">Bike Chains</h3>
					</div>
				</div>
				<div class="product-category">
					<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/icons/icon-5.png" alt="icon" width="60" height="60">
					<div class="category-content">
		...
		<div class="row row-sm">
			<div class="col-md-4">
				<div class="banner banner1 appear-animate" data-animation-name="fadeIn"
					...
					<figure>
						<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/banners/banner-1.jpg" alt="banner" width="640"
							height="640">
					</figure>
				</div>
			</div>
			<div class="col-md-8">
				<div class="banner banner2 h-100"
					style="background: #101010 no-repeat center/cover url(<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/banners/banner-2.jpg);">
			...
			<div class="row appear-animate" data-animation-name="fadeInUpShorter" data-animation-delay="200">
				<div class="products-slider 5col owl-carousel owl-theme" data-owl-options="{
					...
					<div class="product-default">
						<figure>
							<a href="demo27-product.html">
								<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/products/product-7.jpg" width="280"
									height="280" alt="product">
							</a>
							<div class="label-group">
								<div class="product-label label-hot">HOT</div>
					...
					<div class="product-default">
						<figure>
							<a href="demo27-product.html">
								<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/products/product-8.jpg" width="280"
									height="280" alt="product">
							</a>
							<div class="label-group">
					...
					<div class="product-default">
						<figure>
							<a href="demo27-product.html">
								<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/products/product-9.jpg" width="280"
									height="280" alt="product">
							</a>
							<div class="label-group">
								<div class="product-label label-hot">HOT</div>
					...
					<div class="product-default">
						<figure>
							<a href="demo27-product.html">
								<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/products/product-10.jpg" width="280"
									height="280" alt="product">
							</a>
						</figure>
						<div class="product-details">
			...
			<div class="row">
				<div class="col-xl-6 mb-2">
					<div class="banner banner3 d-flex flex-wrap align-items-center bg-gray h-100 appear-animate"
						...
						<div class="col-sm-4">
							<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/banners/banner-3.jpg" alt="banner" width="232"
								height="124">
						</div>
						<div class="col-sm-4 text-center">
				...
				<div class="col-xl-6 mb-2">
					<div class="banner banner4 d-flex flex-wrap align-items-center bg-primary h-100 appear-animate"
						...
						<div class="col-sm-4">
							<img src="<?php echo URLROOT ?>/public/webassets/images/demoes/demo27/banners/banner-4.jpg" alt="banner" width="232"
								height="124">
						</div>
						<div class="col-sm-4 text-center">
