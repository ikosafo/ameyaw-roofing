		...
		<script src="<?php echo URLROOT ?>/public/assets/js/pages/custom/login/login-general1ff3.js?v=7.1.2"></script>
		<script src="<?php echo URLROOT ?>/public/assets/js/pages/custom/notify.js"></script>
		<script src="<?php echo URLROOT ?>/public/assets/js/pages/ajaxscripts.js"></script>
	</body>
</html>
